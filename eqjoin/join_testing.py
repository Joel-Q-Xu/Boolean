import sys, os
sys.path.insert(0, os.path.abspath('/home/peng/PycharmProjects/EquiJoinsOverEncryptedData-main/EquiJoinsOverEncryptedData-main/hash_based_impl/table_a.in'))
sys.path.insert(1, os.path.abspath('/home/peng/PycharmProjects/EquiJoinsOverEncryptedData-main/EquiJoinsOverEncryptedData-main/hash_based_impl/table_b.in'))
